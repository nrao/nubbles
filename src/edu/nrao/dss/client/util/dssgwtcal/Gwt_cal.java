...
public class Gwt_cal implements EntryPoint {
	...
	public void onModuleLoad() {
        ...
        Event event = new Event(0, "Event", "desc", start, start, end, end, "blue"); //"test", "test", "test");
...
//        dayView.addAppointment(appt2);
        Event event2 = new Event(0, "Event2", "desc2", start, start,  end2, end2, "blue"); //, "test", "test", "test");
        
        dayView.addAppointments(event2.getAppointments());

        Date end3 = new Date((long) (dt.getTime() + (2.0 * 24.0 * 60.0 * 60.0 * 1000.0)));
        Event event3 = new Event(0, "Event3", "desc3", start, start, end3, end3, "blue"); //"test", "test", "test");
