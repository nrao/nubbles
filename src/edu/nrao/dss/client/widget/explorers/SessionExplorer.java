...
public class SessionExplorer extends Explorer {
    ...
    private static final ColumnType[] columnTypes = {
        ...
        new ColumnType("source_ra",        "Source RA",       75, false, HourField.class),
        new ColumnType("source_dec",       "Source Dec",      75, false, DegreeField.class),
        new ColumnType("source_lat",       "Source Lat",      75, false, DegreeField.class),
        new ColumnType("source_long",      "Source Long",     75, false, DegreeField.class),
        ...
        new ColumnType("gas",              "Good Atm. Stb.",  65, false, Boolean.class),
    	};
