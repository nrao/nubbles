...
public class Scheduler extends Viewport implements EntryPoint {
    ...
    private void initLayout() {
        ...
        rp.add(new Html("<br/><a href=\"https://help.nrao.edu\" target=\"_blank\">Support Center</a> | <a href=\"http://www.gb.nrao.edu/~rmaddale/Weather/DSSOverview.html\" target=\"_blank\">Weather</a> | <a href=\"http://www.gb.nrao.edu/~rmaddale/Weather/CloudCoverage.html\" target=\"_blank\">Cloud Coverage</a> | <a href=\"#\" onClick=\"window.open('/scheduler/projects/ical', 'iCalendar', 'scrollbars=yes');return false;\">iCalendar</a> | <a href=\"/accounts/logout/\">Logout</a>"));
        rp.add(tabPanel);
    }
